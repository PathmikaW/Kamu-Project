...
<head>
    ...
    <link rel='stylesheet' type="text/css" href="usr2css.css">
...
<body>
    ...
    <a href="#"><i class="fas fa-user"></i><span>View profile</span></a>
    <a href="#"><i class="fas fa-envelope"></i><span>Inbox</span></a>
    <a href="#"><i class="fas fa-question-circle"></i><span>Contact admin</span></a>
    <a href="contact_nutritionist.php"><i class="fas fa-user-md"></i><span>Contact Nutritionist</span></a>
